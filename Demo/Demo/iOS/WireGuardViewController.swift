...
private let tunnelIdentifier = "com.vpn-mobile-app.demo.WGvpn"
...
class WireGuardViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        textAddress.text = "100.0.2.253/32"
        textClientPrivateKey.text = "MJaZjD2ZwmyzqA0Qy5Q2l1TNEkatg+Acy7+pvVYuPFg="
        textServerPublicKey.text = "D+CydtYrU7MxRiGPgRgtIVcJhlGBbYhr+32AOInghiM="
        textServerAddress.text = "103.159.50.156"
        textServerPort.text = "33001"
